...
class TicketActionResolver
{
    ...
    /**
     * Mengembalikan daftar aksi yang tersedia untuk tiket berdasarkan status dan pengguna.
     *
    ...
    public function availableActions(Ticket $ticket, User $user): array
    {
        ...
        $isAdminOrManager =
            in_array(TicketActor::Admin, $actors, true) ||
            in_array(TicketActor::Manager, $actors, true);
        $isTechnicianPemegang = in_array(
        ...
        $actions = match ($status) {
            TicketStatusName::Open => match (true) {
                ...
                $isTechnicianBukanPemegang => [TicketAction::Start],
                $isReporter => [
                    TicketAction::Comment,
                    TicketAction::Attach,
                    TicketAction::Edit,
    ...
    /**
     * Mengembalikan daftar field yang dapat diedit oleh pengguna.
     *
     * @return list<string>
     */
