...
class TicketStatusService
{
    ...
    /**
     * Melakukan transisi status pada tiket
     */
    ...
    /**
     * Menerapkan transisi status pada tiket
     */
    private function applyTransition(
        ...
        // Batalkan transisi ke CLOSED tanpa note
        if (
        ...
        // target RESOLVED: record resolved_at timestamp.
        ...
        // target CLOSED: record closed_at timestamp.
        ...
        // Selalu simpan riwayat status_id
        $this->writeHistory(
            $ticket,
            $actor,
            'status_id',
    ...
    /**
     * Melempar exception jika technician belum ditugaskan.
     */
    private function failTechnicianRequired(
        string $fromLabel,
        string $toLabel,
    ): never {
        throw new IllegalStatusTransitionException(
    ...
    /**
     * Mengembalikan audit action berdasarkan status awal dan akhir.
     */
    private function auditActionFor(
        TicketStatusName $from,
        TicketStatusName $to,
    ): AuditAction {
        return match (true) {
    ...
    /**
     * Helper untuk mendapatkan deskripsi audit berdasarkan status awal dan akhir.
     */
    ...
    /**
     * Helper untuk notifikasi transisi status ticket.
     */
    ...
    /**
     * Helper untuk notifikasi saat ticket dibuka kembali.
     */
    ...
    /**
     * Helper untuk notifikasi kepada penerima berdasarkan koleksi pengguna.
     */
    ...
    /**
     * Helper untuk menulis riwayat perubahan status ticket.
     */
    ...
    /**
     * Helper untuk menyimpan catatan terkait ticket.
     */
