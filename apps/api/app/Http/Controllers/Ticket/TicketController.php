...
class TicketController extends Controller
{
    ...
    /**
     * Mengembalikan daftar tiket yang telah dipaginasi.
     */
    ...
    /**
     * Membuat tiket baru berdasarkan data yang diberikan.
     */
    ...
    public function update(
        ...
        $fields = array_values(
            array_intersect($whitelist, array_keys($request->validated())),
        );

        $ticket = $this->ticketService->update(
            $ticket,
            UpdateTicketData::fromArray($request->validated(), $fields),
            $request->user(),
        );
    ...
    /**
     * Menghapus tugas teknisi dari tiket.
     */
