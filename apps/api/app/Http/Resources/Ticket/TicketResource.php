    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'status' => $this->whenLoaded(
                'status',
                fn () => $this->status->only('id', 'name'),
            ),
            'priority' => $this->whenLoaded(
                'priority',
                fn () => $this->priority->only('id', 'name', 'sla_minutes'),
            ),
            'category' => $this->whenLoaded(
                'category',
                fn () => $this->category->only('id', 'name'),
            ),
            ...
            'attachments_count' => $this->whenLoaded(
                'attachments',
                fn () => $this->attachments->count(),
            ),
            'available_actions' => $user
                ? $actionResolver->availableActions($this->resource, $user)
                : [],
            'editable_fields' => $user
                ? $actionResolver->editableFields($this->resource, $user)
                : [],
