    ...
    ->withExceptions(function (Exceptions $exceptions): void {
        ...
        $exceptions->render(function (Throwable $e, Request $request) {
            ...
            return match (true) {
                ...
                $e instanceof ModelNotFoundException => ApiResponse::error('Resource not found.', status: 404),
                ...
                $e instanceof TooManyRequestsHttpException => tap(
                    ApiResponse::error('Too many requests.', status: 429),
                    function (JsonResponse $response) use ($e): void {
                        $response->header(
                            'Retry-After',
                ...
                $e instanceof StateConflictException => ApiResponse::error(
                    $e->getMessage() ?: 'State conflict.',
                    status: 409,
                ),
